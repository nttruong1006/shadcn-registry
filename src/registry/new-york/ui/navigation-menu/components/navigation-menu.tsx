...
export const NavigationMenuItem = ({ className, ...props }: ComponentProps<typeof Item>) => {
  // Template
  return <Item className={cn('relative', className)} data-slot='navigation-menu-item' {...props} />
}
...
export const NavigationMenuTrigger = ({ className, children, ...props }: ComponentProps<typeof Trigger>) => {
  // Template
  return (
    <Trigger
...
export const NavigationMenuContent = ({ className, ...props }: ComponentProps<typeof Content>) => {
  // Template
  return (
    <Content
      className={cn(
...
export const NavigationMenuLink = ({ className, ...props }: ComponentProps<typeof Link>) => {
  // Template
  return (
    <Link
      className={cn(
