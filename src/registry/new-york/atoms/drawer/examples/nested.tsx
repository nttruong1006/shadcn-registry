          ...
          <Drawer showSwipeHandle={isMobile} swipeDirection={swipeDirection}>
            ...
            <DrawerContent>
              <DrawerHeader>
                ...
                <DrawerDescription>The parent drawer stays mounted behind this one.</DrawerDescription>
              </DrawerHeader>
              <div className='flex-1 p-4'>
                <div className='bg-muted group-data-[swipe-axis=y]/drawer-popup:aspect-video group-data-[swipe-axis=x]/drawer-popup:size-full group-data-[swipe-axis=y]/drawer-popup:w-full' />
              </div>
                ...
                <Drawer showSwipeHandle={isMobile} swipeDirection={swipeDirection}>
                  ...
                  <DrawerContent>
                    <DrawerHeader>
                      ...
                      <DrawerDescription>Two drawers are stacked behind this one.</DrawerDescription>
                    </DrawerHeader>
                    <div className='flex-1 p-4'>
                      <div className='bg-muted group-data-[swipe-axis=y]/drawer-popup:aspect-video group-data-[swipe-axis=x]/drawer-popup:size-full group-data-[swipe-axis=y]/drawer-popup:w-full' />
                    </div>
                      ...
                      <Drawer showSwipeHandle={isMobile} swipeDirection={swipeDirection}>
                        ...
                        <DrawerContent>
                          <DrawerHeader>
                            ...
                            <DrawerDescription>This is the frontmost drawer in the stack.</DrawerDescription>
                          </DrawerHeader>
                          <div className='flex-1 p-4'>
                            <div className='bg-muted group-data-[swipe-axis=y]/drawer-popup:aspect-video group-data-[swipe-axis=x]/drawer-popup:size-full group-data-[swipe-axis=y]/drawer-popup:w-full' />
                          </div>
