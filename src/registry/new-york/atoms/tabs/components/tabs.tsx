...
import { createContext, type RefObject, useCallback, useContext, useLayoutEffect, useRef, useState } from 'react'
...
export function Tabs({
  ...
  const changeValue = useCallback(
    (newValue: string, eventDetails: Parameters<NonNullable<TabsPrimitive.Root.Props['onValueChange']>>[1]) => {
  ...
  return (
    <TabsPrimitive.Tab
      className={cn(
        ...
        'hover:text-primary data-active:text-primary-foreground data-active:hover:text-primary-foreground',
        className
      )}
