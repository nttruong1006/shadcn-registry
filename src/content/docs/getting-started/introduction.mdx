---
title: Introduction
description: NTT Shadcn Registry is a collection of accessible components built for use with Shadcn/ui and Base UI.
---
...
If there are any components that you would like to see added to this library, please feel free to open an issue on the <a href={GITHUB_REPO_URL} target='_blank' rel='noreferrer'>GitHub repository</a>.
